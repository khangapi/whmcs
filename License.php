...
class License
{
    ...
    protected function makeCall($url, $query_string, $timeout = 5)
    {
		...
		*/
        ...
        $results["registeredname"] = "KHANGORU.COM";
        $results["productname"] = "WHMCS KHANGORI.COM";
        $results["productid"] = "5";
